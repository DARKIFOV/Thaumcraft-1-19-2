# Thaumcraft Legacy Rebuild v11.62.54-hotfix7 — полный экспертный технический отчёт, редакция R8

**Снимок кода:** v11.62.54  
**Исправленный пакет:** v11.62.54-hotfix7  
...
`reports/tc4_full_research_thaumonomicon_audit_11.62.54-hotfix7.json`
