...
for token in ['tc4_stage183_focus_renderer_layers_audit.py', 'python scripts/tc4_stage183_focus_renderer_layers_audit.py', 'thaumcraft-legacy-rebuild-stage194-jars']:
