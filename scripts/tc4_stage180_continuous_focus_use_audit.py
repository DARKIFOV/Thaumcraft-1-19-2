...
for token in ['tc4_stage180_continuous_focus_use_audit.py', 'python scripts/tc4_stage180_continuous_focus_use_audit.py', 'thaumcraft-legacy-rebuild-stage204-jars']:
