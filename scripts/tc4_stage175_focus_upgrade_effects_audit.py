...
for token in ['tc4_stage175_focus_upgrade_effects_audit.py', 'python scripts/tc4_stage175_focus_upgrade_effects_audit.py', 'thaumcraft-legacy-rebuild-stage204-jars']:
