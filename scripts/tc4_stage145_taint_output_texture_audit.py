...
checks = {
    "stage145_resources_preserved_on_current_version": any((f"version = '{v}'" in files["build"] and f'version="{v}"' in read("src/main/resources/META-INF/mods.toml")) for v in ["1.94.0", "1.78.0", "1.76.0", "1.70.0", "1.65.0", "1.64.0", "1.63.0", "1.62.0", "1.61.0", "1.60.0", "1.59.0", "1.58.0", "1.57.0", "1.56.0", "1.55.0", "1.54.0", "1.53.0", "1.52.0", "1.51.0", "1.50.0", "1.49.0", "1.48.0", "1.47.0", "1.46.0", "1.45.0"]),
