...
for token in ['tc4_stage176_focus_projectile_visuals_audit.py', 'python scripts/tc4_stage176_focus_projectile_visuals_audit.py', 'thaumcraft-legacy-rebuild-stage194-jars']:
