...
for token in ['tc4_stage179_architect_client_overlay_audit.py', 'python scripts/tc4_stage179_architect_client_overlay_audit.py', 'thaumcraft-legacy-rebuild-stage194-jars']:
