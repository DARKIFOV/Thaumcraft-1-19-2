...
if 'tc4_stage743_762_infusion_failure_arcane_node_audit.py' not in workflow:
    raise AssertionError('workflow does not run Stage743-762 audit')

print('Stage743-762 infusion failure/arcane/node audit: OK')
