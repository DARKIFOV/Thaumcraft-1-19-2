...
checks: dict[str, bool] = {
    "version_stage149_or_later": any((f"version = '{v}'" in build and f'version="{v}"' in mods) for v in ["1.94.0", "1.78.0", "1.76.0", "1.70.0", "1.65.0", "1.64.0", "1.63.0", "1.62.0", "1.61.0", "1.60.0", "1.59.0", "1.58.0", "1.57.0", "1.56.0", "1.55.0", "1.54.0", "1.49.0", "1.50.0", "1.53.0", "1.52.0", "1.51.0"]),
    ...
    "github_ci_guard_stage149_or_later": "tc4_stage149_research_page_parity_audit.py" in guard and any(v in guard for v in ["1.94.0", "1.78.0", "1.76.0", "1.70.0", "1.65.0", "1.64.0", "1.63.0", "1.62.0", "1.61.0", "1.60.0", "1.59.0", "1.58.0", "1.57.0", "1.56.0", "1.55.0", "1.54.0", "1.49.0", "1.50.0", "1.53.0", "1.52.0", "1.51.0"]),
