...
checks=[
 ...
 ['python3','tools/java_parse_guard_116405.py'],
 ['python3','tools/java_syntax_guard.py'],
 ['python3','tools/validate_json_resources.py'],
 ['python3','tools/validate_runtime_manifest.py','--manifest','runtime_artifacts/runtime_test_manifest.template.json','--version','11.64.05','--template'],
...
for i,c in enumerate(checks,1):
 ...
 if x.returncode:
  print(f'FOCUSED STATIC CI v11.64.05: FAIL at check {i}',file=sys.stderr); raise SystemExit(x.returncode)
print(f'FOCUSED STATIC CI v11.64.05: PASS ({len(checks)}/{len(checks)})')
