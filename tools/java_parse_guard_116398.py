#!/usr/bin/env python3
"""Targeted javac parse guard for files changed in v11.63.98."""
from pathlib import Path
import subprocess,tempfile
ROOT=Path(__file__).resolve().parents[1]
PURE=[ROOT/'src/main/java/com/darkifov/thaumcraft/research/TC4ResearchMasteryCombinationParity.java']
FORGE=[
 ROOT/'src/main/java/com/darkifov/thaumcraft/research/ResearchTableInventoryRuntime.java',
 ROOT/'src/main/java/com/darkifov/thaumcraft/research/ResearchTableFoundation.java',
 ROOT/'src/main/java/com/darkifov/thaumcraft/research/PlayerAspectKnowledge.java',
 ROOT/'src/main/java/com/darkifov/thaumcraft/blockentity/ResearchTableBlockEntity.java',
 ROOT/'src/main/java/com/darkifov/thaumcraft/menu/ResearchTableMenu.java',
