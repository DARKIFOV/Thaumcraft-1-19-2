...
FORGE=[R/p for p in [
'src/main/java/com/darkifov/thaumcraft/block/TC4FertilityLampParity.java',
'src/main/java/com/darkifov/thaumcraft/block/TC4EssentiaLampBlock.java',
'src/main/java/com/darkifov/thaumcraft/blockentity/TC4EssentiaLampBlockEntity.java',
'src/main/java/com/darkifov/thaumcraft/client/render/TC4EssentiaLampRenderer.java',
...
with tempfile.TemporaryDirectory() as td:
 pure=[R/'src/main/java/com/darkifov/thaumcraft/block/TC4FertilityLampParity.java',R/'tools/java_contracts/TC4FertilityLampParitySelfTest.java']
 ...
 r=subprocess.run(['java','-cp',td,'TC4FertilityLampParitySelfTest'],cwd=R,text=True,stdout=subprocess.PIPE,stderr=subprocess.STDOUT,timeout=30)
...
print(f'Targeted Java parse guard v11.64.30: PASS (Java 17 self-test + {len(FORGE)} Forge parse checks)')
