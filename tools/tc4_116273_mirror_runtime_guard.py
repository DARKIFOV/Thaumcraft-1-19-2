#!/usr/bin/env python3
"""Regression guard for v11.62.91 TC4 stationary/essentia/hand mirror runtime."""
...
for rel, token in [
    ("build.gradle", "version = '11.62.91'"),
    ("src/main/resources/META-INF/mods.toml", 'version="11.62.91"'),
...
if errors:
    print(f"TC4 11.62.91 mirror runtime guard: FAIL ({len(errors)} problems; {checks} checks)")
    for error in errors:
        print(" -", error)
    sys.exit(1)
print(f"TC4 11.62.91 mirror runtime guard: PASS ({checks}/176 checks)")
