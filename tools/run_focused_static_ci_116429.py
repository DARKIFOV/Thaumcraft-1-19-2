...
checks=[
 ...
 ['python3','tools/validate_runtime_manifest.py','--manifest','runtime_artifacts/runtime_test_manifest.template.json','--version','11.64.29','--template'],
...
for i,c in enumerate(checks,1):
 ...
 if r.returncode:print(f'FOCUSED STATIC CI v11.64.29: FAIL at {i}',file=sys.stderr);raise SystemExit(r.returncode)
print(f'FOCUSED STATIC CI v11.64.29: PASS ({len(checks)}/{len(checks)})')
