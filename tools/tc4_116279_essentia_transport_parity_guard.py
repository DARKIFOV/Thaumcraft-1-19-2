#!/usr/bin/env python3
"""Static source-contract guard for v11.62.90 TC4 essentia transport parity.
...
check("build version 11.62.90", "version = '11.62.90'" in build)
check("mods version 11.62.90", 'version="11.62.90"' in mods)
...
check("runtime manifest version 11.62.90", manifest.get("version") == "11.62.90")
