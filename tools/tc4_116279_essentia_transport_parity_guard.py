#!/usr/bin/env python3
"""Static source-contract guard for v11.62.92 TC4 essentia transport parity.
...
check("build version 11.62.92", "version = '11.62.92'" in build)
check("mods version 11.62.92", 'version="11.62.92"' in mods)
...
check("runtime manifest version 11.62.92", manifest.get("version") == "11.62.92")
