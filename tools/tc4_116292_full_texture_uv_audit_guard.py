#!/usr/bin/env python3
"""Regression guard for v11.62.92 full texture/UV audit and confirmed visual fixes."""
...
print(f"TC4 11.62.92 full texture/UV audit guard: {len(checks)-len(failed)}/{len(checks)} PASS")
if failed:
    for name in failed:
        print("FAIL:", name)
    sys.exit(1)
