...
CONTRACTS = {
    ...
    "node_transducer": ("NodeTransducerItem.java", "NodeTransducerItemRenderer"),
    ...
    "tallow_candle": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_orange": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_magenta": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_light_blue": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_yellow": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_lime": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_pink": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_gray": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_light_gray": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_cyan": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_purple": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_blue": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_brown": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_green": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_red": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    "tallow_candle_black": ("TallowCandleBlockItem.java", "TallowCandleItemRenderer"),
    ...
    "vis_relay": ("VisRelayBlockItem.java", "VisChargeRelayItemRenderer"),
    "alembic": ("AlembicBlockItem.java", "AlembicItemRenderer"),
    "alchemical_centrifuge": ("AlchemicalCentrifugeBlockItem.java", "AlchemicalCentrifugeItemRenderer"),
    "bellows": ("BellowsBlockItem.java", "BellowsItemRenderer"),
    "infusion_matrix": ("InfusionMatrixBlockItem.java", "InfusionMatrixItemRenderer"),
    "tc4_jar_brain": ("BrainJarBlockItem.java", "BrainJarItemRenderer"),
    "essentia_jar": ("EssentiaJarBlockItem.java", "EssentiaJarItemRenderer"),
    "filtered_essentia_jar": ("EssentiaJarBlockItem.java", "EssentiaJarItemRenderer"),
    "void_essentia_jar": ("EssentiaJarBlockItem.java", "EssentiaJarItemRenderer"),
    "tc4_travel_trunk": ("TravelingTrunkItem.java", "TravelingTrunkItemRenderer"),
}
    ...
    for item, (item_file_name, renderer_name) in CONTRACTS.items():
        ...
        checks = {
            ...
            "registered_id": f'"{item}"' in mod_source
                    or f'"{item}"' in (JAVA_ROOT / "com/darkifov/thaumcraft/porting/TC4ResearchItems.java").read_text(encoding="utf-8"),
        }
        if item_file:
