...
FORGE=[R/p for p in [
'src/main/java/com/darkifov/thaumcraft/block/TC4GrowthLampParity.java',
...
with tempfile.TemporaryDirectory() as td:
 pure=[R/'src/main/java/com/darkifov/thaumcraft/block/TC4GrowthLampParity.java',R/'tools/java_contracts/TC4GrowthLampParitySelfTest.java']
 ...
 r=subprocess.run(['java','-cp',td,'TC4GrowthLampParitySelfTest'],cwd=R,text=True,stdout=subprocess.PIPE,stderr=subprocess.STDOUT,timeout=30)
...
print(f'Targeted Java parse guard v11.64.29: PASS (Java 17 self-test + {len(FORGE)} Forge parse checks)')
