...
require("build version 11.62.92", "version = '11.63.23'" in build)
require("mods version 11.62.92", 'version="11.63.23"' in mods)
...
if errors:
    for error in errors:
        print("::error::" + error)
    print(f"TC4 11.63.10 Wisp FlyingMob spawn-rules compile guard: FAIL ({checks-len(errors)}/{checks})")
    sys.exit(1)

print(f"TC4 11.63.10 Wisp FlyingMob spawn-rules compile guard: PASS ({checks}/{checks})")
