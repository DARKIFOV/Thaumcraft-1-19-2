...
PURE=ROOT/'src/main/java/com/darkifov/thaumcraft/research/TC4ResearchCompletionWarpParity.java'
FORGE=[
 ROOT/'src/main/java/com/darkifov/thaumcraft/research/OriginalResearchProgression.java',
...
with tempfile.TemporaryDirectory() as td:
 ...
 if r.returncode: print('Targeted Java parse guard v11.64.02: FAIL (pure contract)'); print(r.stdout); raise SystemExit(1)
for path in FORGE:
 ...
 if bad: print(f'Targeted Java parse guard v11.64.02: FAIL ({path.name})'); print('\n'.join(bad[:120])); raise SystemExit(1)
print('Targeted Java parse guard v11.64.02: PASS (3 changed Java files; pure contract compiled)')
