#!/usr/bin/env python3
"""Static source/resource contract guard for v11.62.84 TC4 taint ecology parity."""
...
check('build version', "version = '11.62.84'" in build)
check('mods version', 'version="11.62.84"' in mods)
...
check('manifest version', manifest.get('version')=='11.62.84')
