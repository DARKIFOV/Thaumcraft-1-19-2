#!/usr/bin/env python3
"""Regression guard for CI run 79602857964 compile blockers fixed in v11.62.92."""
...
need(".github/workflows/build.yml", "Validate retained v11.62.84 Forge compiler hotfix")
need(".github/workflows/release.yml", "Validate retained v11.62.84 Forge compiler hotfix")
if errors:
    print(f"TC4 11.62.92 Forge compile hotfix guard: FAIL ({len(errors)} problems; {checks} checks)")
    for e in errors: print(" -",e)
    sys.exit(1)
print(f"TC4 11.62.92 Forge compile hotfix guard: PASS ({checks} checks)")
