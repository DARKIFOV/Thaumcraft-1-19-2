...
if errors:
    print(f"TC4 11.62.84 Forge compile hotfix guard: FAIL ({len(errors)} problems; {checks} checks)")
    for e in errors: print(" -",e)
    sys.exit(1)
print(f"TC4 11.62.84 Forge compile hotfix guard: PASS ({checks} checks)")
