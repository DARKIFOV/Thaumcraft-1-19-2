...
checks=[
 ...
 ['python3','tools/validate_runtime_manifest.py','--manifest','runtime_artifacts/runtime_test_manifest.template.json','--version','11.64.25','--template'],
...
for i in range(1,len(checks)+1):
 ...
 if code:
  print(f'FOCUSED STATIC CI v11.64.25: FAIL at check {i}',file=sys.stderr)
  raise SystemExit(code)
print(f'FOCUSED STATIC CI v11.64.25: PASS ({len(checks)}/{len(checks)})')
