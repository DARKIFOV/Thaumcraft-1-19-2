...
if errors:
    print(f"TC4 11.62.88 original GUI/infusion guard: FAIL ({len(errors)} problems)")
    for e in errors: print(' -',e)
    raise SystemExit(1)
print(f"TC4 11.62.88 original GUI/infusion guard: PASS ({checks} checks)")
