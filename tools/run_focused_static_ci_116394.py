...
COMMANDS=[
 ...
 'python3 tools/tc4_116368_golem_parity_guard.py',
 'python3 tools/tc4_116369_arcane_vis_guard.py',
 ...
 'python3 tools/validate_runtime_manifest.py --manifest runtime_artifacts/runtime_test_manifest.template.json --version 11.63.94 --template',
