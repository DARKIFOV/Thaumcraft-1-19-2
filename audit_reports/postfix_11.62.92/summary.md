# Полный статический аудит текстур и UV — Thaumcraft Legacy Rebuild 11.62.92

## Область

- База порта: `Thaumcraft_Legacy_Rebuild_Forge_1.19.2_v11.62.92_FULL_TEXTURE_UV_AUDIT_HOTFIX_SOURCE`.
...
- Статусы: `{'STATIC_CONTRACT_GUARDED': 39, 'STATIC_REVIEW_REQUIRED': 31}`.
- Подтверждённых source-level расхождений: **0**.

### Подтверждённое расхождение

- Нет подтверждённых расхождений в выбранном baseline-режиме.
