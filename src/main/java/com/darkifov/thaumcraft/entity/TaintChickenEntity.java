...
/** TC4 EntityTaintChicken: aggressive chicken body with taint statistics and drops. */
public final class TaintChickenEntity extends Chicken implements TaintedMob {
    public TaintChickenEntity(EntityType<? extends Chicken> type, Level level) {
        super(type, level);
        xpReward = 3;
    }
    ...
    @Override protected void registerGoals() {
        ...
        targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, Animal.class, 10, false, false,
    ...
    @Override protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHit) {
        spawnAtLocation(random.nextInt(4) == 0
                ? new ItemStack(com.darkifov.thaumcraft.ThaumcraftMod.TAINTED_SLIME.get())
                : new ItemStack(com.darkifov.thaumcraft.ThaumcraftMod.TC4_RESEARCH_ITEMS.get("tc4_taint_tendril").get()));
    }
}
