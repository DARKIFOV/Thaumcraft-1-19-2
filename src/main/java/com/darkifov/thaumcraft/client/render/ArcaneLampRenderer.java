...
/** Exact TC4 TileArcaneLampRenderer nozzle and Arcane Bore Base connector path. */
public final class ArcaneLampRenderer implements BlockEntityRenderer<ArcaneLampBlockEntity> {
    ...
    @Override
    public void render(ArcaneLampBlockEntity lamp, float partialTick, PoseStack pose,
                       MultiBufferSource buffer, int light, int overlay) {
        Direction facing = lamp.getBlockState().getValue(ArcaneLampBlock.FACING);
    ...
    @Override public boolean shouldRenderOffScreen(ArcaneLampBlockEntity lamp) { return true; }
}
