...
public class TC4VoidPickaxeItem extends PickaxeItem {
    public TC4VoidPickaxeItem(Properties properties) {
        super(TC4VoidToolTier.INSTANCE, 1, -2.8F, properties.stacksTo(1));
    }
