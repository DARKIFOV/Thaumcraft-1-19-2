...
public class TC4VoidShovelItem extends ShovelItem {
    public TC4VoidShovelItem(Properties properties) {
        super(TC4VoidToolTier.INSTANCE, 1.5F, -3.0F, properties.stacksTo(1));
    }
