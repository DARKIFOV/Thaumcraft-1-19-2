...
public final class TC4RecipeItemResolver {
    ...
    static {
        ...
        ITEM_META.put("itemEldritchObject:0", "thaumcraft:eldritch_eye");
        ITEM_META.put("itemEldritchObject:1", "thaumcraft:tc4_crimson_rites");
        ITEM_META.put("itemEldritchObject:2", "thaumcraft:eldritch_eye_2");
        ITEM_META.put("itemEldritchObject:3", "thaumcraft:eldritch_eye_3");
        ...
        ITEM_META.put("itemGolemUpgrade:0", "thaumcraft:golem_upgrade_air");
        ITEM_META.put("itemGolemUpgrade:1", "thaumcraft:golem_upgrade_earth");
        ITEM_META.put("itemGolemUpgrade:2", "thaumcraft:golem_upgrade_fire");
        ITEM_META.put("itemGolemUpgrade:3", "thaumcraft:golem_upgrade_water");
        ITEM_META.put("itemGolemUpgrade:4", "thaumcraft:golem_upgrade_order");
        ITEM_META.put("itemGolemUpgrade:5", "thaumcraft:golem_upgrade_entropy");
        ...
        ITEM_META.put("itemResource:1", "thaumcraft:nitor");
        ...
        ITEM_META.put("itemResource:6", "thaumcraft:amber");
        ...
        ITEM_META.put("itemResource:11", "thaumcraft:tainted_slime");
        ITEM_META.put("itemResource:12", "thaumcraft:tc4_taint_tendril");
        ITEM_META.put("itemResource:13", "thaumcraft:jar_label");
        ...
        ITEM_META.put("itemWandCap:0", "thaumcraft:iron_wand_cap");
        ITEM_META.put("itemWandCap:1", "thaumcraft:gold_wand_cap");
        ITEM_META.put("itemWandCap:2", "thaumcraft:thaumium_wand_cap");
        ...
        ITEM_META.put("itemWandCap:6", "thaumcraft:thaumium_wand_cap_inert");
        ITEM_META.put("itemWandCap:7", "thaumcraft:tc4_wand_cap_void");
        ITEM_META.put("itemWandCap:8", "thaumcraft:tc4_wand_cap_void_inert");
        ITEM_META.put("itemWandRod:0", "thaumcraft:greatwood_wand_core");
        ITEM_META.put("itemWandRod:1", "thaumcraft:tc4_wand_rod_obsidian");
        ITEM_META.put("itemWandRod:2", "thaumcraft:silverwood_wand_core");
        ...
        ITEM_DIRECT.put("itemGolemBell", "thaumcraft:golem_bell");
        ITEM_DIRECT.put("itemGolemDecoration", "thaumcraft:golem_deco_armor");
        ...
        ITEM_DIRECT.put("itemInkwell", "thaumcraft:scribing_tools");
        ...
        ITEM_DIRECT.put("itemResearchNotes", "thaumcraft:research_note");
        ...
        ITEM_DIRECT.put("itemSanitySoap", "thaumcraft:sanity_soap");
        ...
        BLOCK_META.put("blockCustomPlant:0", "thaumcraft:greatwood_sapling");
        BLOCK_META.put("blockCustomPlant:1", "thaumcraft:silverwood_sapling");
        ...
        BLOCK_META.put("blockMagicalLeaves:0", "thaumcraft:greatwood_leaves");
        BLOCK_META.put("blockMagicalLeaves:1", "thaumcraft:silverwood_leaves");
