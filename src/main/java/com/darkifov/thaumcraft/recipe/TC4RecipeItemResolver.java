...
public final class TC4RecipeItemResolver {
    ...
    static {
        ...
        ITEM_META.put("itemNugget:0", "thaumcraft:tc4_nuggetiron");
        ...
        ITEM_META.put("itemNugget:6", "thaumcraft:tc4_nuggetthaumium");
        ...
        ITEM_META.put("itemResource:2", "thaumcraft:tc4_thaumiumingot");
        ITEM_META.put("itemResource:3", "thaumcraft:tc4_quicksilver");
        ...
        ITEM_META.put("itemResource:16", "thaumcraft:tc4_voidingot");
        ITEM_META.put("itemResource:17", "thaumcraft:tc4_voidseed");
        ITEM_META.put("itemResource:18", "thaumcraft:tc4_coin");
        ITEM_META.put("itemShard:0", "thaumcraft:tc4_shard_aer");
        ITEM_META.put("itemShard:1", "thaumcraft:tc4_shard_ignis");
        ITEM_META.put("itemShard:2", "thaumcraft:tc4_shard_aqua");
        ITEM_META.put("itemShard:3", "thaumcraft:tc4_shard_terra");
        ITEM_META.put("itemShard:4", "thaumcraft:tc4_shard_ordo");
        ITEM_META.put("itemShard:5", "thaumcraft:tc4_shard_perditio");
        ITEM_META.put("itemShard:6", "thaumcraft:tc4_shard_balanced");
        ...
        BLOCK_META.put("blockCosmeticSolid:4", "thaumcraft:tc4_block_obsidian_totem_3");
        BLOCK_META.put("blockCosmeticSolid:5", "thaumcraft:tc4_block_obsidian_totem_4");
        ...
        BLOCK_META.put("blockMagicalLog:0", "thaumcraft:tc4_block_greatwood_log");
        BLOCK_META.put("blockMagicalLog:1", "thaumcraft:tc4_block_silverwood_log");
        BLOCK_META.put("blockMetalDevice:0", "thaumcraft:tc4_block_metal_base");
        BLOCK_META.put("blockMetalDevice:1", "thaumcraft:tc4_block_alembic");
        BLOCK_META.put("blockMetalDevice:3", "thaumcraft:tc4_block_advanced_alchemical_furnace");
        ...
        BLOCK_META.put("blockMetalDevice:12", "thaumcraft:tc4_block_mnemonic_matrix");
        ...
        BLOCK_META.put("blockTube:0", "thaumcraft:tc4_block_essentia_tube");
        BLOCK_META.put("blockTube:1", "thaumcraft:tc4_block_essentia_tube");
        BLOCK_META.put("blockTube:4", "thaumcraft:tc4_block_essentia_tube");
        ...
        BLOCK_META.put("blockWoodenDevice:6", "thaumcraft:tc4_block_greatwood_planks");
        BLOCK_META.put("blockWoodenDevice:7", "thaumcraft:tc4_block_silverwood_planks");
        BLOCK_META.put("blockWoodenDevice:8", "thaumcraft:tc4_block_banner");
        VANILLA_ITEMS.put("field_151005_D", "minecraft:flint_and_steel");
        VANILLA_ITEMS.put("field_151006_E", "minecraft:apple");
        VANILLA_ITEMS.put("field_151007_F", "minecraft:string");
        VANILLA_ITEMS.put("field_151008_G", "minecraft:feather");
        VANILLA_ITEMS.put("field_151014_N", "minecraft:ender_pearl");
        VANILLA_ITEMS.put("field_151015_O", "minecraft:blaze_rod");
        VANILLA_ITEMS.put("field_151016_H", "minecraft:gunpowder");
        VANILLA_ITEMS.put("field_151021_T", "minecraft:book");
        VANILLA_ITEMS.put("field_151027_R", "minecraft:bow");
        VANILLA_ITEMS.put("field_151028_Y", "minecraft:flint");
        VANILLA_ITEMS.put("field_151030_Z", "minecraft:porkchop");
        VANILLA_ITEMS.put("field_151031_f", "minecraft:iron_sword");
        VANILLA_ITEMS.put("field_151032_g", "minecraft:arrow");
        VANILLA_ITEMS.put("field_151033_d", "minecraft:iron_axe");
        VANILLA_ITEMS.put("field_151035_b", "minecraft:iron_pickaxe");
        VANILLA_ITEMS.put("field_151036_c", "minecraft:iron_axe");
        VANILLA_ITEMS.put("field_151040_l", "minecraft:stick");
        ...
        VANILLA_ITEMS.put("field_151046_w", "minecraft:bowl");
        VANILLA_ITEMS.put("field_151047_v", "minecraft:mushroom_stew");
        VANILLA_ITEMS.put("field_151055_y", "minecraft:redstone");
        VANILLA_ITEMS.put("field_151059_bz", "minecraft:quartz");
        VANILLA_ITEMS.put("field_151061_bv", "minecraft:nether_star");
        VANILLA_ITEMS.put("field_151064_bs", "minecraft:carrot");
        VANILLA_ITEMS.put("field_151065_br", "minecraft:potato");
        VANILLA_ITEMS.put("field_151068_bn", "minecraft:emerald");
        VANILLA_ITEMS.put("field_151070_bp", "minecraft:skeleton_skull");
        VANILLA_ITEMS.put("field_151072_bj", "minecraft:blaze_powder");
        VANILLA_ITEMS.put("field_151073_bk", "minecraft:magma_cream");
        VANILLA_ITEMS.put("field_151074_bl", "minecraft:gold_nugget");
        VANILLA_ITEMS.put("field_151078_bh", "minecraft:rotten_flesh");
        VANILLA_ITEMS.put("field_151079_bi", "minecraft:ender_eye");
        VANILLA_ITEMS.put("field_151097_aZ", "minecraft:cod");
        VANILLA_ITEMS.put("field_151100_aR", "minecraft:black_dye");
        VANILLA_ITEMS.put("field_151103_aS", "minecraft:bone");
        VANILLA_ITEMS.put("field_151111_aL", "minecraft:glass_bottle");
        VANILLA_ITEMS.put("field_151112_aM", "minecraft:spider_eye");
        VANILLA_ITEMS.put("field_151114_aO", "minecraft:glowstone_dust");
        VANILLA_ITEMS.put("field_151115_aP", "minecraft:cod");
        VANILLA_ITEMS.put("field_151116_aA", "minecraft:sugar");
        VANILLA_ITEMS.put("field_151117_aB", "minecraft:cake");
        VANILLA_ITEMS.put("field_151118_aC", "minecraft:red_bed");
        VANILLA_ITEMS.put("field_151119_aD", "minecraft:clay_ball");
        VANILLA_ITEMS.put("field_151120_aE", "minecraft:repeater");
        VANILLA_ITEMS.put("field_151121_aF", "minecraft:cookie");
        VANILLA_ITEMS.put("field_151123_aH", "minecraft:slime_ball");
        VANILLA_ITEMS.put("field_151128_bU", "minecraft:nether_wart");
        VANILLA_ITEMS.put("field_151131_as", "minecraft:clock");
        VANILLA_ITEMS.put("field_151132_bS", "minecraft:quartz");
        VANILLA_ITEMS.put("field_151133_ar", "minecraft:compass");
        VANILLA_ITEMS.put("field_151137_ax", "minecraft:shears");
        VANILLA_ITEMS.put("field_151144_bL", "minecraft:ghast_tear");
        VANILLA_ITEMS.put("field_151145_ak", "minecraft:paper");
        VANILLA_ITEMS.put("field_151148_bJ", "minecraft:experience_bottle");
        VANILLA_ITEMS.put("field_151156_bN", "minecraft:fire_charge");
        VANILLA_ITEMS.put("field_151166_bC", "minecraft:writable_book");
