...
public final class TC4FullPortDriftLedger {
    ...
    public static final List<DriftEntry> ENTRIES = List.of(
            ...
            new DriftEntry("infusion", "runtime-audited", List.of("TileInfusionMatrix", "ConfigRecipes", "InfusionRecipe", "InfusionEnchantmentRecipe"), List.of("catalyst/components", "enchantment index", "instability", "unlock gates", "materialized recipes"), List.of("instability micro-timings", "essentia suction races", "uncommon recipes"), List.of("block entity tick adapter")),
