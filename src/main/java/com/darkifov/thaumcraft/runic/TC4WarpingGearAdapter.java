...
public final class TC4WarpingGearAdapter {
    private static final Map<String, Integer> WARP_BY_ITEM = Map.ofEntries(
            ...
            Map.entry("thaumcraft:tc4_voidrobechest", 2),
            Map.entry("thaumcraft:tc4_voidrobechestover", 2),
            Map.entry("thaumcraft:tc4_voidrobehelm", 2),
            Map.entry("thaumcraft:tc4_voidrobelegs", 2),
            Map.entry("thaumcraft:tc4_voidrobelegsover", 2),
            Map.entry("thaumcraft:tc4_voidrobeboots", 2),
            ...
            Map.entry("thaumcraft:tc4_primal_crusher", 2),
            ...
            Map.entry("thaumcraft:tc4_jar_brain", 1)
    );
