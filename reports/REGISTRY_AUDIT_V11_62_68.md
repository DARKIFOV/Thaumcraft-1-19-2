# Registry and resource audit — v11.62.68

- Item model JSON files: **716**
- Parsed successfully: **716**
- Statically detected registered item/block-item models: **417**
- Quarantined exact IDs: **122**
- Quarantined prefixes: **31**
- Exact duplicate model groups: **22**
- Visual duplicate groups: **64**
