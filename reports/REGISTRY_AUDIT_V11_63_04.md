# Registry and resource audit — v11.63.04

- Item model JSON files: **725**
- Parsed successfully: **725**
- Statically detected registered item/block-item models: **426**
...
- `brainy_zombie_spawn_egg`, `giant_brainy_zombie_spawn_egg`, `thaumic_slime_spawn_egg`, `wisp_spawn_egg`
