# Registry and resource audit — v11.62.63

- Item model JSON files: **713**
- Parsed successfully: **713**
- Statically detected registered item/block-item models: **410**
- Quarantined exact IDs: **122**
- Quarantined prefixes: **31**
- Exact duplicate model groups: **21**
- Visual duplicate groups: **63**
