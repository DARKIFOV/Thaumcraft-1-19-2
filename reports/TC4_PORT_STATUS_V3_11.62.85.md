# Thaumcraft Legacy Rebuild 11.62.85 — объективный статус порта
...
|---|---|---|---|---|---|---|---|
| Аспекты и tags | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; 48 source entries; scan/tag runtime required |
| Таумометр | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; scan/overlay source guards; range/sound/repeat runtime required |
| Таумономикон | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; 201 entries/591 pages plus v11.62.82 targeted-note inventory flow source audit; browser popup, GUI scales and note-creation runtime required |
| Research Table | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; v11.62.82 source audit: Thaumonomicon-only note creation, table-only unfinished-note editing, completed item learning, fixed inventory and bookshelf/Brain Jar bonus sources; Expertise/Mastery/duplication/save runtime required |
| Arcane Workbench | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; recipe/cost source guards; vis/research/GUI runtime required |
| Жезлы/фокусы | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; renderer and cost source guards; all contexts/network runtime required |
| Узлы/Node Jar | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | NOT TESTED | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; node source audit; six types/three modifiers runtime required |
| Essentia jars | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; NBT-aware BEWLR source contract; 48 labels runtime required |
| Essentia transport | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; v11.62.79 source audit: reservoir suction 24/six faces/active pull and buffer real-suction arbitration; conflict/rollback/soak runtime required |
| Furnace/alembics/centrifuge | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; v11.62.79 source audit: centrifuge queues input while output is occupied or redstone-paused; complete chain runtime required |
| Infusion Matrix | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; recipe and renderer guards; stability/events/save runtime required |
| JEI | PARTIAL | NOT TESTED | NOT TESTED | N/A | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; source plugin/recipe registration; JEI and no-JEI runtime required |
| Bone Bow | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; charge/item-model source contract; arrows/enchants/visual runtime required |
| Traveling Trunk | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; entity/inventory/model/capability source contract; runtime required |
| Crimson cultists | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | NOT TESTED | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; humanoid renderer source contract; four-role side-by-side runtime required |
| Fortress Armor | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; dedicated model source contract; slim/default/masks runtime required |
| Големы | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; USE marker-side/empty-hand handling, weighted fishing quality and priority creeper avoidance are source-guarded; all materials/cores/upgrades/markers still require runtime |
| Warp/Eldritch | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | NOT TESTED | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; v11.62.81 source audit: effect-only Warp Ward authority with legacy NBT migration, separate sticky-event decay, full bucket/counter sync, TC4 spawn search and 0.75 Death Gaze cone; runtime/network/visual proof required |
| Taint/Eerie/Forest | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | NOT TESTED | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; v11.62.80 source audit: five fibre states, persistent taint columns, original spread thresholds, spore lifecycle and taint-spider renderer; biome colours/weather, cleanse and structures still require runtime |
| Outer Lands | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | NOT TESTED | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; aligned portal maze, TC4 portal-room geometry and lock-gated boss cycle in source; traversal/save/return runtime required |
| Mirrors | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; source mirror contracts; cross-dimension/save/automation runtime required |
| Brain in a Jar | PARTIAL | NOT TESTED | NOT TESTED | NOT TESTED | N/A | NOT TESTED | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; source XP/renderer contract; comparator/NBT/visual runtime required |
| Миграция миров | PARTIAL | NOT TESTED | N/A | NOT TESTED | NOT TESTED | N/A | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; legacy aliases/source mapping; five-version migration runtime required |
| Dedicated server | PARTIAL | NOT TESTED | N/A | NOT TESTED | NOT TESTED | N/A | `reports/TC4_11.62.85_FULL_STATIC_CI.log`, `reports/visual_parity_audit_v11.62.85.json`; server-safe source guards; two-client runtime required |
...
|---|---|---|
| `gradlew build` | FAIL / NOT OBTAINED | `reports/TC4_11.62.85_LOCAL_GRADLE_BUILD_ATTEMPT.log` |
