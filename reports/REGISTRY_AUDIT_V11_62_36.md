# Registry and resource audit — v11.62.36

- Item model JSON files: **689**
- Parsed successfully: **689**
- Statically detected registered item/block-item models: **383**
- Quarantined exact IDs: **122**
- Quarantined prefixes: **31**
- Exact duplicate model groups: **20**
- Visual duplicate groups: **61**
