...
- `thirdperson_righthand`: **44** моделей
- `thirdperson_lefthand`: **43** моделей
- `firstperson_righthand`: **43** моделей
- `firstperson_lefthand`: **43** моделей
- `head`: **0** моделей
- `gui`: **15** моделей
- `ground`: **6** моделей
- `fixed`: **14** моделей
