# Registry and resource audit — v11.62.95

- Item model JSON files: **723**
- Parsed successfully: **723**
- Statically detected registered item/block-item models: **423**
- Quarantined exact IDs: **122**
- Quarantined prefixes: **31**
- Exact duplicate model groups: **25**
- Visual duplicate groups: **66**
...
- `alembic`, `hungry_chest`, `vis_relay`
